...
parser.add_argument('--model', type=str, default="FC-DenseNet56",
...
model_checkpoint_name = checkpoint_dir + "/latest_model_" + args.model + "_" + args.dataset + ".ckpt"
    ...
    if epoch % args.validation_step == 0:
        ...
        for ind in val_indices:
            ...
            input_image = np.expand_dims(
                np.float32(utils.load_image(val_input_names[ind])[:args.crop_height, :args.crop_width]), axis=0) / 255.0
